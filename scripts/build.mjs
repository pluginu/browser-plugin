...
await build({ entryPoints: { background: 'src/background/index.js', content: 'src/content/index.js', ui: 'src/shared/ui.js', skills: 'src/domains/page.js' }, bundle: true, outdir: 'dist', target: 'chrome120', format: 'iife', sourcemap: true });
